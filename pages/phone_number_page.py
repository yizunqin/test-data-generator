...
class PhoneNumberPage(BasePage):
    ...
    def create_widgets(self):
        self.layout.addWidget(QLabel("生成随机手机号码"))
    ...
    def generate_data(self):
        ...
        try:
            ...
            self.data = [self.data_generator.generate_phone_number() for _ in range(num)]  # 这里调用的是generate_phone_number，需根据实际需求修改
            self.display_data()
            # QMessageBox.information(self, "生成成功", f"成功生成 {num} 条随机手机号码")
        except ValueError:
